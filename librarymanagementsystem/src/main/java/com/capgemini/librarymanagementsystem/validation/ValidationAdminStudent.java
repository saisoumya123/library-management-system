  ...
  public class ValidationAdminStudent { 
		...
		//	String nameRegEx = "^[A-Za-z\\s]{1,}[\\.]{0,1}[A-Za-z\\s]{0,}$" ;
			...
			if (matcher.matches()) {
				...
				throw new ValidationException("Name should be minimum of 8 letters and to seperate you can only use underscore or hiphen");
			}
			return result;
		}
		...
		public boolean validatedEmail(String email) throws ValidationException {
			...
			if (matcher.matches()) {
				...
				throw new ValidationException("You can enter only gmail or googlemail ");
			}
			return result;
		}
